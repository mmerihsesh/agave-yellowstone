...
Контейнер по умолчанию запускает solana-test-validator с включённым плагином Yellowstone gRPC.
Образ сведен к минимальному размеру с сохранением возможности для дебага и проверок, но дальнейшая оптимизация реализуема 
